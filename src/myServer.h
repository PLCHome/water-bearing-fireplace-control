 ...
 * This function is called in the main loop to manage ongoing web server interactions.
 */
void WEBloop();
 ...
 * This function broadcasts the provided sensor readings to all WebSocket clients.
 */
