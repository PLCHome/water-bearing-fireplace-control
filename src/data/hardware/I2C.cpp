...
bool I2C::isActive() const { return this->active && this->I2Cone; }

int I2C::getSDA() const { return this->sda; }
int I2C::getSDL() const { return this->sdl; }

TwoWire *I2C::getTwoWire() const { return this->I2Cone; }
